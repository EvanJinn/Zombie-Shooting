...
public class JoystickSquare : MonoBehaviour, IPointerUpHandler, IPointerDownHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData data)
    {
        ...
        if (useY)
        {
            ...
            //delta = Mathf.Clamp(delta, -MovementRange,  MovementRange); // dont clamp movement range in y axis (better for right stick)
            newPos.y = delta;
        }
